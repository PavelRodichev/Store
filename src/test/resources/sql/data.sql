...
INSERT INTO products (name, product_article, product_description, product_price, product_amount, category_id, image, is_available) VALUES
-- Electronics
('MacBook Pro 16"', 'MBP16-001', 'Apple MacBook Pro 16 inch with M2 Pro chip', 2499.99, 15, 1, '/images/macbook-pro.jpg', true),
('iPhone 15 Pro', 'IP15P-002', 'Latest iPhone with advanced camera system', 999.99, 50, 1, '/images/iphone15.jpg', true),
('Samsung Galaxy S23', 'SGS23-003', 'Android flagship smartphone', 899.99, 30, 1, '/images/galaxy-s23.jpg', true),
('Sony WH-1000XM5', 'SONY-XM5', 'Noise cancelling wireless headphones', 349.99, 25, 1, '/images/sony-headphones.jpg', true),
...
('Gardening Tools Set', 'GARDEN-302', 'Complete gardening tools set', 79.99, 30, 4, '/images/gardening-tools.jpg', true);